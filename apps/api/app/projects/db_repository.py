            ...
            with connection.cursor() as cursor:
                cursor.execute(
                    ...
                    VALUES (
                        ...
                        %(name)s,
                        %(lane_count)s,
                        %(has_outside_shoulder)s,
                        %(has_inside_shoulder)s,
                        %(ramp_count)s,
                        %(linear_reference_mode)s,
                        %(client_name)s,
                        %(route)s,
                        %(roadway)s,
                        %(direction)s,
                    ...
                    """,
                    {
                        ...
                        "linear_reference_mode": project.linear_reference_mode.value,
            ...
            with connection.cursor() as cursor:
                cursor.execute(
                    ...
                    SET
                        ...
                        name = %(name)s,
                        lane_count = %(lane_count)s,
                        has_outside_shoulder = %(has_outside_shoulder)s,
                        has_inside_shoulder = %(has_inside_shoulder)s,
                        ramp_count = %(ramp_count)s,
                        linear_reference_mode = %(linear_reference_mode)s,
